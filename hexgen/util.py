...
def blend_colors(color1, color2):
    return min((color1[0] + color2[0]) // 2, 255), \
        min((color1[1] + color2[1]) // 2, 255), \
        min((color1[2] + color2[2]) // 2, 255)


def lighten(color, amount):
    return min(math.trunc(color[0] + color[0] * amount), 255), \
        min(math.trunc(color[1] + color[1] * amount), 255), \
        min(math.trunc(color[2] + color[2] * amount), 255)
